...
public:
	...
	void compile() {
		string vsSource = loadFileAsString(csPath);

		cout << "compiling cs shader: " << csPath << endl;

		int cs = compileShader(vsSource, GL_COMPUTE_SHADER);
		...
		if (isLinked == GL_FALSE) {
			...
			cout << "error while linking cs shader " << endl;
