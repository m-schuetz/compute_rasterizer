...
function renderComputeHQS_1x64bit_float(node, view, proj, target){
	...
	if(typeof computeHQS_1x64State_float === "undefined"){

		let pathRenderDepth = `${rootDir}/modules/compute_hqs_1x64bit_float/render_depth.cs`;
		let pathRenderAttribute = `${rootDir}/modules/compute_hqs_1x64bit_float/render_attribute.cs`;
		let pathResolve = `${rootDir}/modules/compute_hqs_1x64bit_float/resolve.cs`;
	...
	let {csRenderDepth, csRenderAttribute, csResolve} = computeHQS_1x64State_float;
	let {ssboDepthbuffer, ssboFramebuffer, ssRG, ssBA} = computeHQS_1x64State_float;
	let {fbo} = computeHQS_1x64State_float;
