...
function render_compute_uint16(node, view, proj, target){


	GLTimestamp("compute-uint16-start");

	// TODO support resizing
	let width = 3000;
	let height = 2000;

	if(typeof computeState_uint16 === "undefined"){

		let pathRender = `${rootDir}/modules/compute_uint16/render.cs`;
		let pathResolve = `${rootDir}/modules/compute_uint16/resolve.cs`;
	...
	let csRender = computeState_uint16.csRender;
	let csResolve = computeState_uint16.csResolve;
	let ssboFramebuffer = computeState_uint16.ssboFramebuffer;
	let fbo = computeState_uint16.fbo;
	...
	{ // RENDER
		...
		GLTimestamp("compute-compute_uint16-render-start");
		...
		gl.useProgram(0);
		GLTimestamp("compute-compute_uint16-render-end");
	}


	{ // RESOLVE
		GLTimestamp("compute-compute_uint16-resolve-start");
		...
		gl.useProgram(0);
		GLTimestamp("compute-compute_uint16-resolve-end");
	}
	...
	GLTimestamp("compute-compute_uint16-end");
